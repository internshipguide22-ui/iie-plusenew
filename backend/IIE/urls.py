...
urlpatterns = [
    ...
    path('api/quiz/results-dashboard/', v.quiz_results_dashboard),
    path('api/quiz/results-export/<str:export_format>/', v.quiz_results_export),
    path('api/quiz/practice/', v.public_practice_quizzes),
    path('api/quiz/practice/<int:quiz_id>/submit/', v.public_practice_submit),
